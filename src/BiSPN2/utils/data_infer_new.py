...
def review_data_process(input_doc, relational_alphabet, entity_type_alphabet, tokenizer, evaluate, repeat_gt_entities=-1, repeat_gt_triples=-1, max_len=495, max_ent=80):
    samples = []
    total_triples = 0
    total_entities = 0
    max_triples = 0
...
class Data:
    ...
    def generate_instance(self, args):
        ...
        self.test_loader = review_data_process(args.test_file, self.relational_alphabet, self.entity_type_alphabet, tokenizer, evaluate=True, max_len=args.max_len)
